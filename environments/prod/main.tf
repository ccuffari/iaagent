# =============================================================================
# AMBIENTE PROD - DISMESSO
# =============================================================================
# Tutti i moduli sono COMMENTATI: l'ambiente prod e' stato dismesso.
# Al prossimo 'apply' Terraform DISTRUGGE tutte le risorse prod (RG, VNet,
